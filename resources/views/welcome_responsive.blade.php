...
<div class= "row" id="responsive">
                   ...
                   <div class="container">
                     ...
                     <div class="row">
                       ...
                       <div class="col-sm hidden-xs">Fecha Elaboración    </div>
                       <div class="col-sm  hidden-xs"><th scope="col">Total    </div>   
                       <div class="col-sm">Opciones    </div>
                   ...
                   <div class="col-sm"><p>{{$dato['order_number']}}</div>
                 
                     <div class="col-sm">   <p>{{$dato['order_nombre']}}</p></div>
                 
                       <div class="col-sm hidden-xs "> 
                           <p> {{substr($dato['order_fecha'], 0, 10) }}</p>
                       </div>
                 
                         <div class="col-sm  hidden-xs">   <p>$ 
                     ...
                     <div class="col-sm">
                       ...
                       @if($dato['order_estado'] != "Borrador")
                       <a href="{{route('autorizar_orden',['order_number'=> $dato['order_number']   ])}}"   class="btn btn-sm btn-circle btn-outline-secondary" title="Autorizar"><i class="fa fa-edit"></i></a>
                        @endif
                       @if($dato['order_estado'] == 'Aprobada')
                       <a href="{{route('generatePDF-b',['order_number'=> $dato['order_number']   ])}}" class="btn btn-sm btn-circle btn-outline-info" title="Descargar Autorizacion"> @include('iconos.pdficon')</a>
                 ...
                 @else
                     ...
                     <div class="col-sm  hidden-xs">     <a href="#" 
...
<!----------Responsive----->
              ...
              <table class="table table-striped table-hover" id="tabla_descktop">
                <thead>
                  ...
                  <tr>
                    ...
                    @role('Contratos')  <th scope="col">Total</th>    @endrole
